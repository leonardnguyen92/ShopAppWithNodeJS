	...
	static {
		try {
			...
			properties.load(new InputStreamReader(Thread.currentThread().getContextClassLoader()
					.getResourceAsStream("manager/utils/message_error.properties"), "UTF-8"));
			...
			System.out.println("Error MessageErrorProperties: " + e.getMessage());
		}
	}
